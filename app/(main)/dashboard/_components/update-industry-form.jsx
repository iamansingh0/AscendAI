...
const UpdateIndustryForm = ({ curIndustry, industries, onCloseDialog }) => {
  ...
  return (
    <div className="flex items-center flex-col justify-center bg-background">
      <p>Current Industry: {curIndustry}</p>
          ...
          <form className="space-y-8" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-2">
              ...
              <Select onValueChange={(val) => {
                ...
                setSelectedIndustry(
                  industries.find((ind) => ind.id === val)
                );
